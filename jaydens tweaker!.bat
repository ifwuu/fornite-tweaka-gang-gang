...
echo.                    [38;5;196m     ══════════════════════════════════════════════════════════════════════════════════════════════════════[0m
echo.                                                                                                                                                                                                     
call                       :color 4 "                         ["&& call :color 6 "0"& call :color 4 "]"& echo  Type "0"  For: Restore Point     
call                       :color 4 "                         ["&& call :color 6 "1"& call :color 4 "]"& echo  Type "1"  For: General Tweaks     
call                       :color 4 "                         ["&& call :color 6 "2"& call :color 4 "]"& echo  Type "2"  For: Windows Tweaks             
call                       :color 4 "                         ["&& call :color 6 "3"& call :color 4 "]"& echo  Type "3"  For: USB Hub Tweaks       
call                       :color 4 "                         ["&& call :color 6 "4"& call :color 4 "]"& echo  Type "4"  For: CPU Tweaks              
call                       :color 4 "                         ["&& call :color 6 "5"& call :color 4 "]"& echo  Type "5"  For: Input Delay Tweaks  
call                       :color 4 "                         ["&& call :color 6 "6"& call :color 4 "]"& echo  Type "6"  For: GPU Tweaks  
call                       :color 4 "                         ["&& call :color 6 "7"& call :color 4 "]"& echo  Type "7"  For: Memory Tweaks
call                       :color 4 "                         ["&& call :color 6 "8"& call :color 4 "]"& echo  Type "8"  For: Storage Tweaks
call                       :color 4 "                         ["&& call :color 6 "9"& call :color 4 "]"& echo  Type "9"  For: Debloat
call                       :color 4 "                         ["&& call :color 6 "10"& call :color 4 "]"& echo  Type "10"  For: Revert
echo.                                        
echo.                    [38;5;196m    ══════════════════════════════════════════════════════════════════════════════════════════════════════[0m
echo.
echo.
...
:contact
cls
start https:\\www.twitter.com/d1lmao
start https://discord.gg/ggPfJyFvyM
cls
goto :menu